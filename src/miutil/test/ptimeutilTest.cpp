...
void PtimeUtilTest::testToBeaufort(){
   string name;
   CPPUNIT_ASSERT(toBeaufort(0.17, name)==string("0") && name == string("Calm"));
	CPPUNIT_ASSERT(toBeaufort(0.24, name)==string("0") && name == string("Calm"));
	CPPUNIT_ASSERT(toBeaufort(0.25, name)==string("1") && name == string("Light air"));

	cerr << "Code: " << toBeaufort(1.54, name) << " name: " << name << "\n";
	CPPUNIT_ASSERT(toBeaufort(1.0, name)==string("1") && name == string("Light air"));
	CPPUNIT_ASSERT(toBeaufort(1.54, name)==string("1") && name == string("Light air"));
	CPPUNIT_ASSERT(toBeaufort(1.55, name)==string("2") && name == string("Light breeze"));

	CPPUNIT_ASSERT(toBeaufort(2.0, name)==string("2") && name == string("Light breeze"));
	CPPUNIT_ASSERT(toBeaufort(3.34, name)==string("2") && name == string("Light breeze"));
	CPPUNIT_ASSERT(toBeaufort(3.35, name)==string("3") && name == string("Gentle breeze"));

	CPPUNIT_ASSERT(toBeaufort(4.0, name)==string("3") && name == string("Gentle breeze"));
	CPPUNIT_ASSERT(toBeaufort(5.44, name)==string("3") && name == string("Gentle breeze"));
	CPPUNIT_ASSERT(toBeaufort(5.45, name)==string("4") && name == string("Moderate breeze"));

	CPPUNIT_ASSERT(toBeaufort(6.0, name)==string("4") && name == string("Moderate breeze"));
	CPPUNIT_ASSERT(toBeaufort(7.94, name)==string("4") && name == string("Moderate breeze"));
	CPPUNIT_ASSERT(toBeaufort(7.95, name)==string("5") && name == string("Fresh breeze"));

	CPPUNIT_ASSERT(toBeaufort(9.0, name)==string("5") && name == string("Fresh breeze"));
	CPPUNIT_ASSERT(toBeaufort(10.74, name)==string("5") && name == string("Fresh breeze"));
	CPPUNIT_ASSERT(toBeaufort(10.75, name)==string("6") && name == string("Strong breeze"));

	CPPUNIT_ASSERT(toBeaufort(12.0, name)==string("6") && name == string("Strong breeze"));
	CPPUNIT_ASSERT(toBeaufort(13.84, name)==string("6") && name == string("Strong breeze"));
	CPPUNIT_ASSERT(toBeaufort(13.85, name)==string("7") && name == string("Near gale"));

	CPPUNIT_ASSERT(toBeaufort(14.0, name)==string("7") && name == string("Near gale"));
	CPPUNIT_ASSERT(toBeaufort(17.14, name)==string("7") && name == string("Near gale"));
	CPPUNIT_ASSERT(toBeaufort(17.15, name)==string("8") && name == string("Gale"));

	CPPUNIT_ASSERT(toBeaufort(19.0, name)==string("8") && name == string("Gale"));
	CPPUNIT_ASSERT(toBeaufort(20.74, name)==string("8") && name == string("Gale"));
	CPPUNIT_ASSERT(toBeaufort(20.75, name)==string("9") && name == string("Strong gale"));

	CPPUNIT_ASSERT(toBeaufort(23.0, name)==string("9") && name == string("Strong gale"));
	CPPUNIT_ASSERT(toBeaufort(24.44, name)==string("9") && name == string("Strong gale"));
	CPPUNIT_ASSERT(toBeaufort(24.45, name)==string("10") && name == string("Storm"));

	CPPUNIT_ASSERT(toBeaufort(26.0, name)==string("10") && name == string("Storm"));
	CPPUNIT_ASSERT(toBeaufort(28.44, name)==string("10") && name == string("Storm"));
	CPPUNIT_ASSERT(toBeaufort(28.45, name)==string("11") && name == string("Violent storm"));

	CPPUNIT_ASSERT(toBeaufort(30.0, name)==string("11") && name == string("Violent storm"));
	CPPUNIT_ASSERT(toBeaufort(32.64, name)==string("11") && name == string("Violent storm"));
	CPPUNIT_ASSERT(toBeaufort(32.65, name)==string("12") && name == string("Hurricane"));
	CPPUNIT_ASSERT(toBeaufort(33.0, name)==string("12") && name == string("Hurricane"));
